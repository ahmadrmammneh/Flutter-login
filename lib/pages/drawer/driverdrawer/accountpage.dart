...
class Accountdriverpage extends StatefulWidget {
  const Accountdriverpage({super.key});

  @override
  _AccountdriverpageState createState() => _AccountdriverpageState();
}

class _AccountdriverpageState extends State<Accountdriverpage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Driver Account", style: TextStyle(color: Colors.white)),
        centerTitle: true,
